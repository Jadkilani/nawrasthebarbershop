...
const dict: Dict = {
  ...
  manageStaff: { en: "Manage Staff", ar: "إدارة الموظفين" },
  ...
  markNoShow: { en: "Mark no-show", ar: "تحديد كعدم حضور" },
  add: { en: "Add", ar: "إضافة" },
  ...
  unavailableMonday: { en: "Unavailable on Monday", ar: "غير متاح يوم الإثنين" },
  unavailableToday: { en: "Not available today", ar: "غير متاح اليوم" },
  staffEmail: { en: "Staff email", ar: "بريد الموظف" },
  insights: { en: "Insights", ar: "إحصائيات" },
  logs: { en: "Activity log", ar: "سجل النشاط" },
  duplicateBookingTitle: { en: "You already have a booking", ar: "لديك حجز نشط بالفعل" },
  duplicateBookingMsg: { en: "We see an active booking on this phone. Are you booking for another person?", ar: "يوجد حجز نشط بهذا الرقم. هل تحجز لشخص آخر؟" },
  yes: { en: "Yes, another person", ar: "نعم، لشخص آخر" },
  no: { en: "No, cancel", ar: "لا، إلغاء" },
